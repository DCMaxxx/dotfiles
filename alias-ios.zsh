...
alias xcode_fix_windows='rm -f ./*.xcworkspace/xcuserdata/*.xcuserdatad/UserInterfaceState.xcuserstate ; rm -f ./*.xcworkspace/xcuserdata/*.xcuserdatad/UserInterfaceState.xcuserstate'
